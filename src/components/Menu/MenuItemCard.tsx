    ...
    <>
      <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg menu-item">
        ...
        <CardContent className="pt-4">
          ...
          <p className="text-burgundy-700 font-semibold">${item.price.toFixed(2)}</p>
        </CardContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center text-amber-500">
                ...
                <span className="text-gray-500 ml-2">({item.reviews.length} reseñas)</span>
              </div>
              <div className="text-burgundy-700 text-xl font-bold">${item.price.toFixed(2)}</div>
            </div>
